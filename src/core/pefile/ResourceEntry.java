...
/**
 * Class / Struct d'une entrée de resource
 * 
 * @author r0da
 */
public class ResourceEntry {
    ...
    public ResourceEntry(int type, int dataEntryOffset, int entryCount, int dataOffset, int size){
        this.type = type;
        this.dataEntryOffset = dataEntryOffset;
